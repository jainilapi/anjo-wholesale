...
$(document).ready(function() {
    ...
    @if(isset($warehouse->country->id))
        $('#country_id').append(new Option('{{ $warehouse->country->name ?? '' }}', '{{ $warehouse->country->id ?? '' }}', true, true));
    @endif
    @if(isset($warehouse->state->id))
        $('#state_id').append(new Option('{{ $warehouse->state->name ?? '' }}', '{{ $warehouse->state->id ?? '' }}', true, true));
    @endif
    @if(isset($warehouse->city->id))
        $('#city_id').append(new Option('{{ $warehouse->city->name ?? '' }}', '{{ $warehouse->city->id ?? '' }}', true, true));
    @endif
