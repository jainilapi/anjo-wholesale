                    ...
                    <div class="card-body">
                        @php
                            $editLink = function ($stepNumber) use ($product) {
                                return route('product-management', ['type' => encrypt('variable'), 'step' => encrypt($stepNumber), 'id' => encrypt($product->id)]);
                            };
                        @endphp

                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 1: General Information</h6>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 2: Product Variants</h6>
                                <a href="{{ $editLink(2) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                            </div>
                            <div class="card-body">
                                <strong>Total Variants:</strong> {{ $reviewData['variants']->count() }}
                                    ...
                                    @foreach ($reviewData['variants'] as $variant)
                                        <li class="list-group-item">
                                            ...
                                            @foreach ($variant->attributes as $attr)
                                                <span
                                                    class="badge bg-light text-dark">{{ $attr->attribute->value }}</span>
                                            @endforeach
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 3: Unit Configuration</h6>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 4: Tier Pricing</h6>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 5: Inventory</h6>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 6: Suppliers</h6>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 7: Categories & SEO</h6>
                        ...
                        <div class="card mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">Step 8: Substitutes</h6>
                                <a href="{{ $editLink(8) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                            </div>
                            <div class="card-body">
                                @php
                                ...
                                @endphp
                                <p>{{ $variantsWithSubstitutes->count() }} out of
                                    {{ $reviewData['substitutes']->count() }} variants have substitutes defined.</p>
                            </div>
                        </div>
