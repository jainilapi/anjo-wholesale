    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="additionalUnitsWrapper" class="d-flex flex-column gap-3">
                    <div class="border rounded p-3" data-id="11">
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" min="1" step="1" class="form-control qty-input"> 
                            </div>
                            <div class="col-md-4">
                                <div class="small text-muted conv-label" style="text-align: center!important;position: relative!important;top: 12px!important;">1 ? = ?</div>
                            </div>
    ...
    $(document).ready(function() {
        ...
        function buildRow(node, map) {
            ...
            <div class="row g-2 align-items-center">\
                ...
                <div class="col-md-4">\
                    <div class="small text-muted conv-label" style="text-align: center!important;position: relative!important;top: 12px!important;"></div>\
                </div>\
                <div class="col-md-2 d-flex gap-2 justify-content-end">\
                    <button type="button" class="btn btn-sm btn-outline-primary add-child">Add Child</button>\
                    <button type="button" class="btn btn-sm btn-outline-danger delete-node">Delete</button>\
        ...
        function renderTree(data) {
            if (data.additional_units.length > 0) {
                $wrapper.empty();
        ...
        function openCreateDialog(parentId) {
            ...
            $wrapper.prepend($dlg);
            $dlg.on('click', '#cancelAdd', function() {
                $dlg.remove();
            });
        ...
        $('#addRootAdditional').on('click', function() {
            openCreateDialog(null);
        });

        $('#baseUnitSelect').each(function() {
            initSelect2($(this));
        });
        ...
        $.post(stepUrl, {
            ...
            if (res.additional_units.length) {
                renderTree(res);
            }
        });
    });
