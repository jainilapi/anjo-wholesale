...
<div class="row">
    <div class="col-md-10 offset-md-1">
        <div class="card">
            ...
            <div class="card-body">
                <form id="productForm" method="POST" action="{{ route('products.update', encrypt($product->id)) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="editor" style="height: 250px;">{!! old('description', $product->description) !!}</div>
